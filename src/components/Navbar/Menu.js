...
return (   
     ...
     { jwt ? 
      ( <nav className="bg-gray-800">
       ...
       flex items-center sm:hidden"></div>
        </div>
      ...
      justify-center sm:items-stretch sm:justify-start">
        ...
        <div className="hidden sm:block sm:ml-6">
          ...
          <div className="flex space-x-4">
            ...
            aria-current="page">Cardlist</Link>

{  isAdmin && token?  <Link to="/form" 
className="text-gray-300 hover:bg-gray-700 
hover:text-white px-3 py-2 rounded-md text-sm 
font-medium">Form</Link> :<> </>}
           
            
            <Link to="/bookningar" 
            className="text-gray-300 hover:bg-gray-700 
            hover:text-white px-3 py-2 rounded-md text-sm 
            font-medium">Mina bookningar</Link>
 ...
 <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
   ...
   <div className="hidden sm:block sm:ml-6">
     ...
     <div className="flex space-x-4">
       ...
       <Link to="/cardlist" className="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Cardlist</Link>

 {isAdmin && token?    <Link to="/form" 
 className="text-gray-300 hover:bg-gray-700 hover:text-white 
 px-3 py-2 rounded-md text-sm font-medium">Form</Link>: <> </>}
